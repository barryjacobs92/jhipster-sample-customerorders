package com.barry.sample.customerorders.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("CustomerOrders");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("CustomerOrders");
        ...
        config.getMapConfigs().put("com.barry.sample.customerorders.domain.*", initializeDomainMapConfig(jHipsterProperties));
